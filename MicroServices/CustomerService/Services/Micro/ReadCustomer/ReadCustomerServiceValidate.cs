...
{
	public class ReadCustomerServiceValidate : IServiceValidate<RequestMessageBaseWithCache<CustomerId, ServerCallContext, ICustomerRepository, IDistributedCache>>
	{
